...
class MRUCache(BaseCaching):
    """MRUCache is a caching system that stores key:value pairs in a
    public instance dictionary using the Most Recently Used algorithm
    """
    def __init__(self):
    ...
    def put(self, key: any, item: any):
        ...
        if key and item:
            if len(self.cache_data) == BaseCaching.MAX_ITEMS\
                ...
                least = max(self.cache_dict.values())
